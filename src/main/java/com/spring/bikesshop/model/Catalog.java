...
public class Catalog {
	 ...
	 * this.idCatalogs = id; this.name = name; this.description = description;
	 * this.pdfUrl = pdfUrl; }
	 * 
	 * public Long getId() { return idCatalogs; }
	 * 
	 * public void setId(Long id) { this.idCatalogs = id; }
	 * 
	 ...
	 * 
	 * @Override public int hashCode() { return Objects.hash(description,
	 * idCatalogs, name, pdfUrl); }
	 * 
	 * @Override public boolean equals(Object obj) { if (this == obj) return true;
	 * if (obj == null) return false; if (getClass() != obj.getClass()) return
	 * false; Catalog other = (Catalog) obj; return Objects.equals(description,
	 * other.description) && Objects.equals(idCatalogs, other.idCatalogs) &&
	 * Objects.equals(name, other.name) && Objects.equals(pdfUrl, other.pdfUrl); }
	 * 
	 * @Override public String toString() { return "Catalog [id=" + idCatalogs +
	 * ", name=" + name + ", description=" + description + ", pdfUrl=" + pdfUrl +
	 * "]"; }
	 */ 
}
