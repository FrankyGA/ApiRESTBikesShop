...
public class Rental {
	...
	@Override
	public int hashCode() {
		return Objects.hash(bike, client, endDate, id, price, shop, startDate);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(bike, other.bike) && Objects.equals(client, other.client)
	...
	public String toString() {
		return "Rental [id=" + id + ", client=" + client + ", bike=" + bike + ", shop=" + shop + ", startDate="
