...
import com.spring.bikesshop.converter.CatalogConvertTo;
...
public class CatalogController {
    ...
    public ResponseEntity<List<CatalogDTO>> getAllCatalogs() {
        ...
        List<CatalogDTO> catalogDTOs = catalogs.stream()
                .map(CatalogConvertTo::convertToDTO)
    ...
    public ResponseEntity<CatalogDTO> getCatalogById(@PathVariable Long id) {
        ...
        return ResponseEntity.ok(CatalogConvertTo.convertToDTO(catalog));
    }
    ...
    public ResponseEntity<CatalogDTO> createCatalog( @RequestBody CatalogDTO catalogDTO) {
        ...
        Catalog catalog = CatalogConvertTo.convertToEntity(catalogDTO);
        Catalog savedCatalog = catalogRepository.save(catalog);
        return ResponseEntity.status(HttpStatus.CREATED).body(CatalogConvertTo.convertToDTO(savedCatalog));
    }
    ...
    public ResponseEntity<CatalogDTO> updateCatalog(@PathVariable Long id, @Valid @RequestBody CatalogDTO updatedCatalogDTO) {
        ...
        Catalog savedCatalog = catalogRepository.save(catalog);
        return ResponseEntity.ok(CatalogConvertTo.convertToDTO(savedCatalog));
    }
    ...
    @GetMapping("/catalogs/{id}/download")
